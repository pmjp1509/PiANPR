...
MODEL_PATH = os.path.join(BASE_DIR, "..", "models", "best2.onnx")
...
VIDEO_PATH = os.path.join(BASE_DIR, "..", "datasets", "under_bridge_center1.mp4")
# ------------------------------------------------------------------
#  Detector (YOLO)
# ------------------------------------------------------------------
...
IMG_SIZE        = 640      # network input (square). Try 512/416/320 on the Pi for speed.
CONF_THRESHOLD  = 0.15
IOU_THRESHOLD   = 0.45
